...
import MediumZoom from 'lightgallery/plugins/mediumZoom/lg-medium-zoom.min.js';
...
if (window.innerWidth <= 800) {
  ...
  document.querySelector('.certificate__sakura').remove();
  document.querySelector('.certificate-zoom-container').remove();
	if (galleries.length) {
		let galleyItems = [];
